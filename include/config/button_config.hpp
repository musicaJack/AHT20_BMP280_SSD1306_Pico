...
// 按键引脚定义
#define BUTTON_KEY1_PIN         8       // 按键1引脚 (GPIO8) - 上一页/返回
#define BUTTON_KEY2_PIN         9       // 按键2引脚 (GPIO9) - 下一页/确认

// === 新增按键定义 ===
// 三个自定义按键
#define BUTTON_SCREEN_POWER_PIN  14     // 屏幕开关按键 (GPIO14) - 控制屏幕开启/关闭
#define BUTTON_PAGE_UP_PIN       8      // 翻页上按键 (GPIO8) - 等同于BUTTON_KEY1_PIN
#define BUTTON_PAGE_DOWN_PIN     9      // 翻页下按键 (GPIO9) - 等同于BUTTON_KEY2_PIN
...
// 双击间隔时间（毫秒）- 禁用双击功能，避免误操作
#define BUTTON_DOUBLE_PRESS_MS  0

// 单击延迟时间（毫秒）- 禁用单击延迟，提升响应速度
#define BUTTON_SINGLE_PENDING_MS 0

// 阅读模式专用双击间隔（设为0禁用双击检测，提升翻页响应速度）
#define READING_MODE_DOUBLE_PRESS_MS  0
