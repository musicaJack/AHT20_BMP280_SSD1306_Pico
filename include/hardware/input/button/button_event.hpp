#pragma once
#include "hardware/input/button/button.hpp"
...
public:
    ...
    // ButtonLogicEvent get_combo_event() const; // 禁用组合键事件
    void reset();
private:
    ...
    // bool key1_double_pending_;      // 禁用双击相关变量
    // bool key2_double_pending_;      // 禁用双击相关变量
    // 组合键 - 禁用
    // bool combo_press_handled_;
    // uint32_t combo_press_time_;
    // bool combo_long_press_handled_;
    // uint32_t combo_long_press_time_;
    // 上一帧状态
    ...
    // mutable ButtonLogicEvent combo_event_;  // 禁用组合键事件
    // 延迟单击判定 - 禁用
